<div class="one-third services"> <img class="icon_left" src="assets/images/icons/book.png" alt="icon" />
        <h2>Clean Design</h2>
      ...
      <div class="one-third services"> <img class="icon_left" src="assets/images/icons/monitor.png" alt="icon"/>
        ...
        <a href="#" class="more">Read more</a></div>
      <div class="hr"></div>
      <div class="one-third services"> <img class="icon_left" src="assets/images/icons/iphone.png" alt="icon" />
        ...
        <a href="#" class="more">Read more</a></div>
      <div class="one-third services"> <img class="icon_left" src="assets/images/icons/drive.png" alt="icon" />
        ...
        <a href="#" class="more">Read more</a></div>
      <div class="hr"></div>
      <div class="two-third services"> <img class="icon_left" src="assets/images/icons/monitor.png" alt="icon" />
      ...
      <div id="twitter_update_list"> Please wait while our tweets load <img src="assets/images/images/indicator.gif" alt="loading"/></div>